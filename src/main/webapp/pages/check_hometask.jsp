...
<html>
<head>
    <title><%=resourceBundle.getString("check_hometask_sign")%></title>
</head>
<body>
...
<h3><%=resourceBundle.getString("hometask_data_sign")%></h3>
<br>
...
<form action="${pageContext.request.contextPath}/hometask">
    ...
    <input type="submit" value=<%=resourceBundle.getString("set_mark_sign")%>>
</form>
</body>
</html>
